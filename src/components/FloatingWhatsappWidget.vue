<template>
  <div>
    ...
    <div
      class="fixed bottom-6 left-6 z-50 transition-all duration-300 ease-in-out"
    >
      <!-- Chat Button -->
      <button
        @click="toggleChat"
      ...
      <div
        v-if="isOpen"
        class="absolute bottom-16 left-0 w-96 h-auto bg-white rounded-2xl shadow-deep border border-gray-200 flex flex-col overflow-hidden"
      >
        <!-- Header -->
        <div
        ...
        >
          <div class="flex items-center gap-3">
            ...
            <div>
              <h2 class="font-bold text-base">Medvax Health WhatsApp</h2>
            </div>
          </div>
          <button
            @click="closeChat"
        ...
        <div class="p-6 flex flex-col items-center gap-4">
          <p class="text-gray-700 text-center text-base">
            Place your order on our business WhatsApp
          </p>
          <a
            :href="chatUrl"
            target="_blank"
            rel="noopener noreferrer"
            class="bg-green-500 hover:bg-green-600 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-300 flex items-center gap-2"
          >
            <svg
              class="w-5 h-5"
              fill="currentColor"
...
const chatUrl = "https://wa.me/2347067125522";
